...
let products = [
  ...
  
    {
        ...
        price: 4.19,
        incart: 0,
        img: 'images/Lactancia_2%_1L_5067.png'
    },

    {
        ...
        price: 7.69,
        incart: 0,
        img: 'images/QUEBON_2%_4L_5067.png'
    },
...

    {
        ...
        price: 4.49,
        incart: 0,
        img: 'images/Natrel_2%_2L_5067.png'
    },
...
function buildCell0Html(product){
	   ...
	   txt = txt +	"<br>";
       txt = txt +	"<button onclick=\"removeItem('"+product.tag+"')\" class=\"rm\">Remove</button>";
	   txt = txt +	"<a href=\"Index_5067.html\"><button>continue shopping</button></a>";
       txt = txt +	"</div>";
       txt = txt +	"</div>";
...
function buildCell1Html(product){
    var txt  = "<input type=\"number\" value=\""+ product.incart+"\"  onkeyup=\"changeQuantity('"+ product.tag+"',this)\"  min=\"0\" >";
    return txt;
}
...
function removeItem(tag){
    ...
    totalCost_number = totalCost_number - product_remove.price * product_remove.incart;
...
function totalCost(products, quantity){
    ...
    if (cartCost != null){
        ...
        localStorage.setItem("totalCost", (cartCost + products.price * quantity).toFixed(2));
    } else {
